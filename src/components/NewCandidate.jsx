...
const NewCandidate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.post('https://60d5a2c2943aa60017768b01.mockapi.io/candidate', formData);
          console.log(response.data);
          navigate('../', { state: { updateList: true } });
        } catch (error) {
    ...
    return (
        <div className='container'>
            <h2 className='title'>New Candidate Form</h2>
